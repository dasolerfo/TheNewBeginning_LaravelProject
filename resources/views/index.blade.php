...
!-->
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><!--<img src="{{ asset('img/logo@3x.png') }}" height="31" alt="logo" />--></a>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"> </span></button>
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">

              <li class="nav-item"><a class="nav-link" aria-current="page" href="#feature">{{__('msg.joc')}}</a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#validation">{{__('msg.informacio')}}</a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#superhero">{{__('msg.trailer')}}</a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#marketing">{{__('msg.actualitzacions')}}</a></li>
            </ul>
            @guest
              <div class="d-flex ms-lg-4"><button class="btn btn-warning" onclick="openFormSingUp()">Sign Up</button></div>
              <div class="d-flex ms-lg-4"><button class="btn btn-warning" onclick="openFormRegist()">Regist</button></div>
            @else
              <div class="d-flex ms-lg-4"> <a class="btn btn-warning" href="{{ route('logout') }}">Logout</a></div>
            @endguest
            <ul class="navbar-nav ms-auto">
              <li class="nav-item"><a class="nav-link" aria-current="page" href="http://127.0.0.1:8000/en">EN</a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="http://127.0.0.1:8000/cat">CAT</a></li>
            </ul>
          </div>
        </div>
    </nav>
    ...
    <div class="form-popup" id="myFormRegist">
      <form action="{{ route('register.post') }}" method="POST" id="footer-form" class="form-container">
        ...
        <div class="row">
          ...
          @endif
          <div class="">
            <input type="password" class="form-control" name="password_confirmation" placeholder="password_confirmed *" id="password">
        </div>
        </div>
        <button type="submit" class="btn btn-primary">Regist</button>
        <button type="button" class="btn cancel" onclick="closeFormRegist()">Close</button>
      </form>
    </div>
    <!-- ===============================================-->
    <!--    Main Content-->
    <!-- ===============================================-->
      ...
      <section class="pt-7">
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-end"><img class="pt-7 pt-md-0 img-fluid" src="{{ asset('img/logo@3x.png') }}" alt="" /></div>
            <div class="col-md-6 text-md-start text-center py-6">
              ...
              <div class="text-center text-md-start"><a class="btn btn-warning me-3 btn-lg" href="#!" role="button">{{__('msg.descargar')}}</a><a class="btn btn-link text-warning fw-medium" href="#!" role="button" data-bs-toggle="modal" data-bs-target="#popupVideo"><span class="fas fa-play me-2"></span>Trailer </a></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="pt-5 pt-md-9 mb-6" id="feature">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block" style="background-image:url({{ asset('img/category/shape.png') }});opacity:.5;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <h1 class="fs-9 fw-bold mb-4 text-center"> {{__('msg.f2')}} <br class="d-none d-xl-block" /> {{__('msg.f3')}}</h1>
          <div class="row">
          ...
          <div class="text-center"><a class="btn btn-warning" href="#!" role="button">{{__('msg.f12')}}</a></div>
      ...
      <section class="pt-5" id="validation">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="{{ asset('img/validation/validation.png') }}" alt="" /></div>
          </div>
        </div><!-- end of .container-->
      ...
      <section class="pt-5" id="manager">
        ...
        <div class="container">
          <div class="row"> 
            <div class="col-lg-6"><img class="img-fluid" src="{{ asset('img/manager/manager.png') }}" alt="" /></div>
            <div class="col-lg-6">
              ...
              <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="{{ asset('img/manager/tick.png') }}" width="35" alt="tick" />
      ...
      <section class="pt-5" id="marketer">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="{{ asset('img/marketer/marketer.png') }}" alt="" /></div>
          </div>
        </div><!-- end of .container-->
      ...
      <section class="py-md-11 py-8" id="superhero">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block background-position-top" style="background-image:url({{ asset('img/superhero/oval.png') }};opacity:.5; background-position: top !important ;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="{{ asset('img/marketing/marketing01.png') }}" alt="" />
            ...
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="{{ asset('img/marketing/marketing02.png') }}" alt="" />
                <div class="card-body ps-0">
                  <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
            ...
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="{{ asset('img/marketing/marketing03.png') }}" alt="" />
                <div class="card-body ps-0">
                  <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
      ...
      <section class="pb-2 pb-lg-5">
        ...
        <div class="container">
          <div class="row border-top border-top-secondary pt-7">
            <div class="col-lg-3 col-md-6 mb-4 mb-md-6 mb-lg-0 mb-sm-2 order-1 order-md-1 order-lg-1"><img class="mb-4" src="{{ asset('img/logo.svg') }}" width="184" alt="" /></div>
